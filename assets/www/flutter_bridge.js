/* ═══════════════════════════════════════════════════════════════
   ...
   2. Patches saveData() to sync full appData to Flutter
      → Flutter stores it in SharedPreferences
      → WorkManager background tasks can read it when app is killed
   3. Patches scheduleAllCapacitorNotifications() to ALSO register
   ...
   4. On load, asks Flutter for any pending AI results generated
